...
f1.boundaries.append([-2.0, 0])
f1.boundaries.append([1.0, 1.5])

f2.boundaries.append([0.5, 0.75])
f2.boundaries.append([1, 1.25])
...
print(
    f"\n x1 -> {newton_method(f2.boundaries[0][0], f2.boundaries[0][1], 10 ** -7, f2.as_func, f2.as_derivative2)[-1]} - {f2.boundaries[0]}")
print(
    f" x2 -> {newton_method(f2.boundaries[1][0], f2.boundaries[1][1], 10 ** -7, f2.as_func, f2.as_derivative2)[-1]} - {f2.boundaries[1]}")

draw_results(hoard_method(f1.boundaries[0][0], f1.boundaries[0][1], 10 ** -7, f1.as_func),
             hoard_method(f1.boundaries[1][0], f1.boundaries[1][1], 10 ** -7, f1.as_func),
             "Hoard method \n" + f1.as_str, f1, "hoard_method.png")

draw_results(newton_method(f2.boundaries[0][0], f2.boundaries[0][1], 10 ** -7, f2.as_func, f2.as_derivative2),
             newton_method(f2.boundaries[1][0], f2.boundaries[1][1], 10 ** -7, f2.as_func, f2.as_derivative2),
